...
The following steps build Cobra verifier and introduce how to run Cobra verifier on existing histories or the histories generated by [Cobra bench](https://github.com/DBCobra/CobraBench).
...
The `[history]` is a history folder; one can get a history from either [CobraLogs](https://github.com/DBCobra/CobraLogs) or running [Cobra bench](https://github.com/DBCobra/CobraBench).
